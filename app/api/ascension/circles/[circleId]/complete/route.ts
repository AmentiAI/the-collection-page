...
export async function POST(
  ...
  try {
    ...
    // Require all participants to mark complete
    const allCompleted = participants.length >= circle.required_participants && completedCount >= circle.required_participants
