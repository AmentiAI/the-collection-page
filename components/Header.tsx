...
export default function Header({ 
  ...
  const socialLinkClasses = 'text-[#ff0000] hover:text-[#ff6b6b] transition-colors duration-200 animate-pulse'
  ...
  return (
    <header className="relative z-[9999] text-center py-3 px-4 bg-gradient-to-b from-[rgba(139,0,0,0.9)] to-[rgba(0,0,0,0.9)] border-b-[3px] border-[#8B0000] shadow-[0_4px_20px_rgba(139,0,0,0.5)]">
      <div className="flex items-center justify-between md:justify-center gap-4">
        ...
        <button
          type="button"
          className="md:hidden inline-flex items-center justify-center rounded border border-[#ff0000]/60 bg-black/60 p-2 text-[#ff0000] hover:text-[#ff6b6b] transition-colors"
      ...
      <div className="hidden md:flex justify-center items-center gap-2 sm:gap-4 mt-3 flex-wrap">
        {socialLinks.map(({ href, label, title: linkTitle, icon }) => (
          <a
            key={linkTitle}
            href={href}
            target="_blank"
            ...
            title={linkTitle}
          >
            {icon('w-6 h-6 sm:w-8 sm:h-8 drop-shadow-[0_0_10px_rgba(255,0,0,0.5)]')}
          </a>
        ))}
        <Link
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 space-y-6 rounded-lg border border-[#8B0000]/60 bg-black/85 px-4 py-4">
          <div className="flex items-center justify-center gap-6 flex-wrap">
            {socialLinks.map(({ href, label, title: linkTitle, icon }) => (
              ...
              >
                {icon('w-7 h-7 drop-shadow-[0_0_10px_rgba(255,0,0,0.5)]')}
              </a>
            ))}
          </div>
      ...
      <div className="hidden md:flex justify-center items-center gap-4 mt-2 flex-wrap">
        <WalletConnect 
          onHolderVerified={onHolderVerified}
          onVerifyingStart={onVerifyingStart}
          onConnectedChange={onConnectedChange}
